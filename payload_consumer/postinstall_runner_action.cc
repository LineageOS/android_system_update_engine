...
void PostinstallRunnerAction::PerformPartitionPostinstall() {
  ...
  // since we can safely assume the slot has been changed. If it hasn't
  // ever been mounted R/W, we can assume that the rom that the user is
  // upgrading to will have everything they need and no addon.d scripts
  // will need to be run to retain stuff after the upgrade.
  //
